...
int main(){
    ...
    if (gnuplotPipe) {   // If gnuplot is found
        ...
        fprintf(gnuplotPipe, "set output 'm1-2-scatter-plot.png'\n");
        ...
        fprintf(gnuplotPipe, "set xlabel 'Runtime'\n");
        ...
        fprintf(gnuplotPipe, "plot './m1-2.txt' using 4:3 w lp lw 1.5 pt 7 ps 2, '' u 2:1 w lp lw 1.5 pt 7 ps 2\n");
