...
int main(){
    ...
    if (gnuplotPipe) {   // If gnuplot is found
        ...
        fprintf(gnuplotPipe, "set output 'm2-scatter-plot.png'\n");
        ...
        fprintf(gnuplotPipe, "set xlabel 'Runtime (in s)'\n");
        ...
        fprintf(gnuplotPipe, "plot './plot.txt' using 4:3 w lp lw 1.5 pt 7 ps 2\n");
