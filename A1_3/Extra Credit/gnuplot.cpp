...
int main(){
    ...
    if (gnuplotPipe) {   // If gnuplot is found
        ...
        fprintf(gnuplotPipe, "set xrange [0:1000]\n");
        fprintf(gnuplotPipe, "set yrange [2:3.2]\n");
        ...
        fprintf(gnuplotPipe, "set output 'flow-scatter-plot.png'\n");
        ...
        fprintf(gnuplotPipe, "plot './plot.txt' using 1:3 with p lw 1.5 pt 7 ps 1, '' using 1:3:2 with labels offset 0,char 1\n");
