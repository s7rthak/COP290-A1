...
int main(){
    ...
    if (gnuplotPipe) {   // If gnuplot is found
        ...
        fprintf(gnuplotPipe, "set output 'line-graph2.png'\n");
        ...
        fprintf(gnuplotPipe, "plot './plot2.txt' using 1:2 with lines title 'Queue Density' lt rgb 'dark-violet' lw 1.5, './plot2.txt' using 1:3 with lines title 'Moving Density' lt rgb 'coral' lw 1.5\n");
